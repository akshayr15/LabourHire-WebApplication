       ...
       <div class="wrapper">
        ...
        <div id="content">
          ...
          <div class="row">
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="LabourId" DataSourceID="SqlDataSource1">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AssignementASPConnectionString %>" SelectCommand="SELECT [ContactNumber], [Email], [Name], [LabourId] FROM [Register]"></asp:SqlDataSource>
                       </div>
              <div class="col-lg-4">
                  <asp:Label ID="Label1" runat="server" CssClass="lbl" Text="Label"></asp:Label>
                  <asp:DropDownList ID="DropDownList1" runat="server" CssClass="hs" DataSourceID="SqlDataSource2" DataTextField="LabourId" DataValueField="LabourId"></asp:DropDownList>
                  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:AssignementASPConnectionString %>" SelectCommand="SELECT [LabourId] FROM [Register]"></asp:SqlDataSource>
              </div>
              <div class="col-lg-4">
                  <asp:Button ID="Button1" runat="server" Text="DELETE" OnClick="del" />
                  <asp:Button ID="Button2" runat="server" Text="ADD" OnClick="Add"  />
